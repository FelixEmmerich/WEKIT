...
namespace Kinect {
	...
	public struct SerialSkeletonFrame
	{
        ...
        public static implicit operator NuiSkeletonFrame(SerialSkeletonFrame ssf)
        {
            return ssf.deserialize();
        }

        public static implicit operator SerialSkeletonFrame(NuiSkeletonFrame nsf)
        {
            return new SerialSkeletonFrame(nsf);
        }
    }
