...
namespace Leap.Unity {
  ...
  public class CapsuleHand : IHandModel {
    ...
    internal const int THUMB_BASE_INDEX = (int)Finger.FingerType.TYPE_THUMB * 4;
    ...
    internal Transform[] _jointSpheres;
    internal Transform mockThumbJointSphere;
    internal Transform palmPositionSphere;

    internal Transform wristPositionSphere;
    ...
    internal int getFingerJointIndex(int fingerIndex, int jointIndex) {
